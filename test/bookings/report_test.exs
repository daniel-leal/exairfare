defmodule Exairfare.Bookings.ReportTest do
  use ExUnit.Case

  import Exairfare.Factory

  alias Exairfare.Bookings.Agent, as: BookingAgent
  alias Exairfare.Bookings.Report
  ...
  describe "call/2" do
    ...
    test "creates the report" do
      ...
      expected_response =
        "70831e44-5820-4b4c-aae1-87b079a2882f,São Leopoldo,Porto Alegre,2020-09-01 12:00:00\n" <>
          "70831e44-5820-4b4c-aae1-87b079a2882f,São Leopoldo,Porto Alegre,2020-09-05 12:00:00\n"
